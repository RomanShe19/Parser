...
Проект-портфолио: **асинхронный парсер Avito** (обход антибот-защиты через `curl-cffi`/`playwright`) + **Telegram-бот** для управления парсингом и просмотра результатов (журнал/поиск/статистика).
